...
- (void)viewDidLoad
{
    ...
    _libraries = [[NSArray alloc] initWithObjects:@"JsonLite", @"JsonLiteData", @"JSONKit", @"JSONKitData", @"JSONKitThread", @"JSONKitThreadData", @"TouchJSON", @"NextiveJson", @"SBJson", @"SBJsonData", @"NSJSONSerialization", nil];
