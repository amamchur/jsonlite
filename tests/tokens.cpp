...
TEST(tokens, should_convert_unicode_string) {
    ...
    EXPECT_EQ(sc[11].utf8, "42\xC3\xA9" "42\xE2\x89\xA5" "42");
    EXPECT_EQ(sc[11].utf16, L"42\xE9" L"42\x2265" L"42");
    ...
    EXPECT_EQ(sc[14].utf8,
              "\v=>x\xED\x93\xAE\xE2\xA3\xABP1\xE0\xA0\xABLMMX'M\xE5\x88\xBC\xE5\x94\xB3\xEB\x90\xA4\xF0\x9D\x9B\xA2 \xD0\x9A \xE0\xAF\xB5 \xEE\x80\x80\xF0\x9D\x9B\xA2\n");
